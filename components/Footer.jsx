      ...
      <footer className="text-gray-600 body-font bg-white">
        <div className="container max-w-7xl px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            ...
            <p className="mt-2 text-base text-gray-800">
              Baratillo Cusco Online su tienda en Linea
            </p>
          </div>
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-bold text-gray-900 tracking-widest text-md mb-3">
                CATEGORIES
              </h2>
        ...
        <div className="bg-indigo-600">
          <div className="container max-w-7xl mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className=" text-center sm:text-left text-sm font-medium text-white">
              © 2021 Diseño Web —
              <a
                href="https://webdesigncusco.com/"
